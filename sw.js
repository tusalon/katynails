...
const urlsToCache = [
  ...
  '/katynails/utils/push-config.js',
  '/katynails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/katynails/icons/icon-192x192.png',
    badge: '/katynails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/katynails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/katynails/admin.html';
  event.waitUntil(
